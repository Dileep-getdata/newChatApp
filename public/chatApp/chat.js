...
chatMsg.addEventListener('submit',async(e)=>{
    try{
        ...
        const imagePth=e.target.image.value;
       const chatPost=await axios.post('http://localhost:3050/chat/chat',{chat:chatMessage,imagepath:imagePth},{headers:{'Authentication':token}});    
